...
/**
 * @title SafuDomainAuction
 * @notice English auction system for premium .safu domain names
 * @dev Supports ETH and USDC bidding with anti-sniping protection
 */
contract SafuDomainAuction is Ownable, ReentrancyGuard {
    using SafeERC20 for IERC20;

    // ============ Structs ============

    struct Auction {
        string name; // Domain name (without .safu)
     ...
     * @param name Domain name (without .safu)
