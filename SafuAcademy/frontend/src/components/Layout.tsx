...
export const Layout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <div className={`w-full min-h-screen ${isDark
      ...
      <nav className={`w-full flex items-center justify-between px-6 lg:px-10 py-4 lg:py-5 backdrop-blur border-b sticky top-0 z-50 ${isDark
        ...
        <div className="flex items-center gap-4 lg:gap-6 text-sm">
          <NavLink
            to="/"
            className={({ isActive }) =>
              `hidden sm:inline-block hover:opacity-100 transition ${isActive
                ? isDark ? 'text-white font-semibold' : 'text-[#111] font-semibold'
                : isDark ? 'text-gray-400 opacity-80' : 'text-[#555] opacity-80'
              }`
            }
          >
            Home
      ...
      <footer className={`w-full pt-20 pb-10 text-center border-t mt-10 ${isDark
        ...
        <button className={`px-10 py-4 rounded-full font-semibold text-base md:text-lg transition shadow-[0_20px_50px_rgba(15,23,42,0.35)] ${isDark
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 mt-10">
          <button className={`px-8 py-3 rounded-full border font-medium transition text-sm ${isDark
          ...
          <button className={`px-8 py-3 rounded-full shadow-sm border flex items-center gap-2 font-medium transition text-sm ${isDark
        ...
        <p className={`mt-12 text-[11px] tracking-[0.18em] uppercase ${isDark ? 'text-gray-500' : 'text-[#777]'
          }`}>
