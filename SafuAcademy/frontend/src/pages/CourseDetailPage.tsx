...
import { abi, Course, Deploy, Lesson } from "@/constants";
    ...
    return (
      <Layout>
        <div className="text-center py-12">
          ...
          <Link to="/courses" className={`font-semibold hover:underline ${isDark ? 'text-[#fffb00]' : 'text-[#92400e]'}`}>
            ← Back to courses
          </Link>
        </div>
      </Layout>
    ...
    <Layout>
      <div className="space-y-6">
        ...
        <div className={`text-[11px] flex items-center gap-2 ${isDark ? 'text-gray-500' : 'text-[#777]'}`}>
          <Link to="/courses" className={`hover:underline ${isDark ? 'hover:text-white' : 'hover:text-safuDeep'}`}>
            All courses
          </Link>
          <span>/</span>
